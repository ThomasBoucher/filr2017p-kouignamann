...
###a.	Utilisateurs directs du produit
  ...
  Nous envisageons un nombre d'association dépassant le million, mais cela peut être très variable avec autant de particuliers que de personnes prêtes à aider.
...
Une documentation utilisateur sera à disposition des membres authentifié au sein de l'application.


###c. Exigences en matière de support
La documentation utilisateur sera numérique, l'utilisateur pourra y accéder après s'être connecté. Lors de sa première connexion, un tutoriel sera proposé à l'utilisateur afin de découvrir les fonctionnalités de l'application.
Les utilisateurs auront également la possibilité de signaler des incidents via un système de tickets.
